...
import img2 from '../assets/resipes/images2.png'
import img3 from '../assets/resipes/images3.png'
import img4 from '../assets/resipes/images4.png'
import img5 from '../assets/resipes/images5.png'
        ...
        <section className="mx-auto mt-24 md:mt-0 max-w-screen-xl p-5 md:p-10 lg:p-12">
            <div className='flex mx-auto flex-col justify-center     relative   container w-full'>
                <motion.h2
                    ...
                    className='text-white text-5xl md:text-6xl lg:text-7xl  xl:text-8xl capitaliz font-bold text-center my-8'>Recipes website</motion.h2>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{
                ...
                >
                    <div
                        ...
                        <div className='flex-row flex gap-3'>
                            <a href="https://github.com/ZiadAlaa984/Yummy" className='hover:bg-stone-900 rounded-full transition-colors duration-500' target='_blank' rel="noopener noreferrer">
                            ...
                            <a href="https://ziadalaa984.github.io/Yummy/" className='hover:bg-stone-900 rounded-full transition-colors duration-500' target='_blank' rel="noopener noreferrer">
                        ...
                        <div className='flex-row justify-center  items-center flex-wrap flex gap-3'>
                            <div className="flex flex-row justify-start items-center pt-3 gap-6">
                                ...
                                <figure className="p-2 border me-2 mb-2 rounded-md duration-700 cursor-pointer transition-all">
                                    <img className="link-technology filter grayscale hover:filter-none transition-all" width={20} src={bootstrap} alt="css" />
                                </figure>
                                <figure className="p-2 border me-2 mb-2 rounded-md duration-700 cursor-pointer transition-all">
                                    <img className="link-technology filter grayscale hover:filter-none transition-all" width={20} src={jq} alt="react" />
                                </figure>
                            </div>
                        </div>
                    </div>
                    <div className='border-b gap-5 p-6 md:p-12   border-stone-800 flex flex-col justify-center items-center  '>
                        <p className='text-2xl text-center text-white font-normal'>
                            A recipe website is a platform where users discover diverse cooking instructions. These sites feature a wide array of recipes categorized by region, ingredient, and meal type. Users can easily search for specific recipes and even watch accompanying YouTube videos for guidance.                        </p>
                    </div>
                </motion.div>
