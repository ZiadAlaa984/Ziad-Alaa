...
import img1 from '../assets/list/list.png'
import img from '../assets/list/image.png'
        ...
        <section className="mx-auto mt-24 md:mt-0 max-w-screen-xl p-5 md:p-10 lg:p-12">
            <div className='flex mx-auto flex-col justify-center     relative   container w-full'>
                <motion.h2
                    ...
                    className='text-white text-5xl md:text-6xl lg:text-7xl  xl:text-8xl capitaliz font-bold text-center my-8'>To-Do-List</motion.h2>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{
                ...
                >
                    <div
                        ...
                        <div className='flex-row flex gap-3'>
                            <a href="https://ziadalaa984.github.io/to-do-list/" className='hover:bg-stone-900 transition-colors duration-500 rounded-full' target='_blank' rel="noopener noreferrer">
                            ...
                            <a href="https://github.com/ZiadAlaa984/to-do-list" className='hover:bg-stone-900 rounded-full transition-colors duration-500' target='_blank' rel="noopener noreferrer">
                    ...
                    <div className='border-b gap-5 p-6 md:p-12   border-stone-800 flex flex-col justify-center items-center  '>
                        <p className='text-2xl text-center text-white font-normal'>
                            A simple Todo List application. The app allows users to add, edit, and delete tasks.
                        </p>
                    </div>
                </motion.div>
