                ...
                <Slider className='' {...settings}>
                    <div className='flex   box justify-center relative items-center'>
                        <div className='  p-16 cursor-grab border-white  w-full text-white'>
                            ...
                            <p className='text-4xl   text-white font-bold overlay  bg-black absolute  transition-opacity delay-100 duration-400 ease-linear opacity-0 left-1 right-1 top-1 bottom-1 flex justify-center items-center h-[98%] 
                            w-[98%]'>Html5</p>
                        </div>
                    </div>
                    <div className='flex   box justify-center relative items-center'>
