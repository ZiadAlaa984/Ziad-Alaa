...
import img from '../assets/freshcard/scr1.png'
import img1 from '../assets/freshcard/scr2.png'
import img2 from '../assets/freshcard/scr3.png'
import img3 from '../assets/freshcard/scr4.png'
import img4 from '../assets/freshcard/scr5.png'
import img5 from '../assets/freshcard/scr6.png'
...
export default function FreshCard() {
    return (
        <section className="mx-auto mt-24 md:mt-0 max-w-screen-xl p-5 md:p-10 lg:p-12">
            <div className='flex mx-auto flex-col justify-center     relative   container w-full'>
                <motion.h2
                    ...
                    className='text-white text-5xl md:text-6xl lg:text-7xl  xl:text-8xl capitaliz font-bold text-center my-8'>Fresh Card</motion.h2>
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{
                ...
                >
                    <div
                        ...
                        <div className='flex-row flex gap-3'>
                            <a href="https://fresh-card-chi.vercel.app/" className='hover:bg-stone-900 transition-colors duration-500 rounded-full' target='_blank' rel="noopener noreferrer">
                            ...
                            <a href="https://github.com/ZiadAlaa984/Fresh-Card" className='hover:bg-stone-900 rounded-full transition-colors duration-500' target='_blank' rel="noopener noreferrer">
